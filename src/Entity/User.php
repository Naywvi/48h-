...
<<<<<<< HEAD
class User extends AbstractType implements PasswordAuthenticatedUserInterface
=======
class User
>>>>>>> a4835a68f10c063b7ad7d3c12bfe2fc4b5830cef
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'user_id', targetEntity: Evenement::class)]
    private $evenements;
